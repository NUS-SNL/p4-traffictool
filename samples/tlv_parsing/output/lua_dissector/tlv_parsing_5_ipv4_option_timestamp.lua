-- protocol naming
p4_proto = Proto('p4_ipv4_option_timestamp','P4_IPV4_OPTION_TIMESTAMPProtocol')

-- protocol dissector function
function p4_proto.dissector(buffer,pinfo,tree)
	pinfo.cols.protocol = 'P4_IPV4_OPTION_TIMESTAMP'
	local subtree = tree:add(p4_proto,buffer(),'P4_IPV4_OPTION_TIMESTAMP Protocol Data')
		...
		subtree:add(buffer(2,1), 'data (8 bits):' .. string.format('%X', tostring(buffer(2,1):bitfield(0,8))))
