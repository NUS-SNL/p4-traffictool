 ...
 * wraparound of the snapshot ID. Does not include logic for snapshotting of
 * channel state.  Also does not include forwarding logic, which can occur in
 * parallel.
 **/
...
#include "./includes/ingress_W.p4"
#include "./includes/egress_W.p4"
#include "./includes/counter_pkt.p4"
#include "./includes/notify.p4"
