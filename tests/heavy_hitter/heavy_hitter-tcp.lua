...
function p4_proto.dissector(buffer,pinfo,tree)
    ...
    subtree:add(buffer(12,1), "res (3 bits) - Binary: " .. tobits(buffer(12,1):uint(), 8, 5, 7))
    subtree:add(buffer(12,1), "ecn (3 bits) - Binary: " .. tobits(buffer(12,1):uint(), 8, 0, 2))
    subtree:add(buffer(13,1), "ctrl (6 bits) - Binary: " .. tobits(buffer(13,1):uint(), 8, 3, 8))
