...
yes y|./p4-traffictool.sh -json samples/arp/arp.json --std p4-16 -o samples/arp/output --scapy --wireshark --moongen --pcpp --debug
...
yes y|./p4-traffictool.sh -json samples/dummy/dummy.json --std p4-14 -o samples/dummy/output --scapy --wireshark --moongen --pcpp --debug
yes y|./p4-traffictool.sh -json samples/heavy_hitter/heavy_hitter.json --std p4-14 -o samples/heavy_hitter/output --scapy --wireshark --moongen --pcpp --debug
yes y|./p4-traffictool.sh -json samples/ipv4/ipv4_forward.json --std p4-16 -o samples/ipv4_forward/output --scapy --wireshark --moongen --pcpp --debug
yes y|./p4-traffictool.sh -json samples/mri/mri.json --std p4-16 -o samples/mri/output --scapy --wireshark --moongen --pcpp --debug
yes y|./p4-traffictool.sh -json samples/simple_nat/simple_nat.json --std p4-14 -o samples/simple_nat/output --scapy --wireshark --moongen --pcpp --debug
yes y|./p4-traffictool.sh -json samples/simple_router/simple_router.json --std p4-14 -o samples/simple_router/output --scapy --wireshark --moongen --pcpp --debug
